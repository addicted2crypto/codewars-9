...
//  and returns the time it takes for that petal to reach the ground from the
//   same branch.

// Notes:

// The movement of the petal is quite complicated, so in this case we can see the 
